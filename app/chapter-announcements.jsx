      ...
      <View style={s.cardBody}>
        ...
        {canShare && (
          <View style={s.shareRow}>
            <Pressable style={s.igShareBtn} onPress={shareToInstagram}>
...
const s = StyleSheet.create({
  ...
  shareIconBtn: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#D0D0D0', justifyContent: 'center', alignItems: 'center' },
